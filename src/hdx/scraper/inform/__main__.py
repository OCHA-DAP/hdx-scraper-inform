...
_USER_AGENT_LOOKUP = "hdx-scraper-inform"
...
def main(
    ...
    if not User.check_current_user_organization_access("inform", "create_dataset"):
        raise PermissionError("API Token does not give access to INFORM organisation!")
